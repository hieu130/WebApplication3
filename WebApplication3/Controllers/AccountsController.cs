...
namespace WebApplication3.Controllers
{
    public class AccountsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,UserName,Password,DisabledAt,Address,Thumbnail,Status,RoleNumber,EmployeeNumber,AddmissionDate,DateOfJoining")] Account account)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,UserName,Password,DisabledAt,Address,Thumbnail,Status,RoleNumber,EmployeeNumber,AddmissionDate,DateOfJoining")] Account account)
        {
            if (ModelState.IsValid)
            {
